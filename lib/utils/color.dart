...
class AppColors {
  ...
  static const Color accentPrimaryColor = Color.fromARGB(255, 45, 45, 62);
  ...
  static const Color bottomNavBarColor = Color(0xff111111);
  ...
  // static const Color primaryGradientColor = Color(0xFF4362FF);
  static const Color highPriorityColor = Colors.redAccent;
  static const Color mediumPriorityColor = Colors.orangeAccent;
  static const Color lowPriorityColor = Colors.lightBlueAccent;
  static const Color noPriorityColor = Colors.lightGreen;
}
